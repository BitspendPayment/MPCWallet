...
class MPCWalletClient extends $grpc.Client {
  ...
  static final _$evtxoKeygenStep1 = $grpc.ClientMethod<$0.EvtxoKeygenStep1Request, $0.EvtxoKeygenStep1Response>(
      '/mpc_wallet.MPCWallet/EvtxoKeygenStep1',
      ($0.EvtxoKeygenStep1Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.EvtxoKeygenStep1Response.fromBuffer(value));
  static final _$evtxoKeygenStep2 = $grpc.ClientMethod<$0.EvtxoKeygenStep2Request, $0.EvtxoKeygenStep2Response>(
      '/mpc_wallet.MPCWallet/EvtxoKeygenStep2',
      ($0.EvtxoKeygenStep2Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.EvtxoKeygenStep2Response.fromBuffer(value));
  static final _$evtxoKeygenStep3 = $grpc.ClientMethod<$0.EvtxoKeygenStep3Request, $0.EvtxoKeygenStep3Response>(
  ...
  $grpc.ResponseFuture<$0.EvtxoKeygenStep1Response> evtxoKeygenStep1($0.EvtxoKeygenStep1Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$evtxoKeygenStep1, request, options: options);
  }

  $grpc.ResponseFuture<$0.EvtxoKeygenStep2Response> evtxoKeygenStep2($0.EvtxoKeygenStep2Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$evtxoKeygenStep2, request, options: options);
  }
...
abstract class MPCWalletServiceBase extends $grpc.Service {
  ...
  MPCWalletServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.EvtxoKeygenStep1Request, $0.EvtxoKeygenStep1Response>(
        'EvtxoKeygenStep1',
        evtxoKeygenStep1_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.EvtxoKeygenStep1Request.fromBuffer(value),
        ($0.EvtxoKeygenStep1Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.EvtxoKeygenStep2Request, $0.EvtxoKeygenStep2Response>(
        'EvtxoKeygenStep2',
        evtxoKeygenStep2_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.EvtxoKeygenStep2Request.fromBuffer(value),
        ($0.EvtxoKeygenStep2Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.EvtxoKeygenStep3Request, $0.EvtxoKeygenStep3Response>(
        'EvtxoKeygenStep3',
        evtxoKeygenStep3_Pre,
        false,
        false,
  ...
  $async.Future<$0.EvtxoKeygenStep1Response> evtxoKeygenStep1_Pre($grpc.ServiceCall call, $async.Future<$0.EvtxoKeygenStep1Request> request) async {
    return evtxoKeygenStep1(call, await request);
  }

  $async.Future<$0.EvtxoKeygenStep2Response> evtxoKeygenStep2_Pre($grpc.ServiceCall call, $async.Future<$0.EvtxoKeygenStep2Request> request) async {
    return evtxoKeygenStep2(call, await request);
  }

  $async.Future<$0.EvtxoKeygenStep3Response> evtxoKeygenStep3_Pre($grpc.ServiceCall call, $async.Future<$0.EvtxoKeygenStep3Request> request) async {
